...
# Title: diagrma3
# Author: Juan_Peña_Javier_Ballesteros_L1B_G4
...
class diagrama3(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "diagrma3", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("diagrma3")
        ...
        self.settings = Qt.QSettings("GNU Radio", "diagrama3")
        ...
        self.high_pass_filter_0 = filter.interp_fir_filter_fff(
            ...
            firdes.high_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/home/labcom/Escritorio/lab-comu-L1B-G4/Lab1_PateB/Audio_de_prueba (1).wav', True)
        self.audio_sink_0 = audio.sink(audio_rate, '', True)
        self._BW_range = Range(100, 21000, 10, 1500, 200)
        ...
        self.connect((self.high_pass_filter_0, 0), (self.rational_resampler_xxx_0_0, 0))
...
def main(top_block_cls=diagrama3, options=None):
